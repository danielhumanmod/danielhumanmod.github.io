    ...
    ct.prototype = {
        ...
        recognize: function(t) {
            ...
            if (!e.stopped) {
                ...
                s = e.curRecognizer; (!s || s && s.state & Te) && (s = e.curRecognizer = null);
...
$(document).ready(function() {
    ...
    function s() {
        ...
        $(".slider--prev1, .slider--next1").click(function() {
            var t = $(this),
            e = $(".slider1").find(".slider--item-left1"),
            i = $(".slider1").children().index(e),
            n = $(".slider1").find(".slider--item-center1"),
            s = $(".slider1").children().index(n),
            r = $(".slider1").find(".slider--item-right1"),
            o = $(".slider1").children().index(r),
            a = $(".slider1").children().length,
            l = $(".slider--item-left1"),
            c = $(".slider--item-center1"),
            h = $(".slider--item-right1"),
            u = $(".slider--item1");
            $(".slider1").animate({
                opacity: 0
            },
            400),
            setTimeout(function() {
                t.hasClass("slider--next1") ? a - 1 > i && a - 1 > s && a - 1 > o ? (l.removeClass("slider--item-left1").next().addClass("slider--item-left1"), c.removeClass("slider--item-center1").next().addClass("slider--item-center1"), h.removeClass("slider--item-right1").next().addClass("slider--item-right1")) : i === a - 1 ? (u.removeClass("slider--item-left1").first().addClass("slider--item-left1"), c.removeClass("slider--item-center1").next().addClass("slider--item-center1"), h.removeClass("slider--item-right1").next().addClass("slider--item-right1")) : s === a - 1 ? (l.removeClass("slider--item-left1").next().addClass("slider--item-left1"), u.removeClass("slider--item-center1").first().addClass("slider--item-center1"), h.removeClass("slider--item-right1").next().addClass("slider--item-right1")) : (l.removeClass("slider--item-left1").next().addClass("slider--item-left1"), c.removeClass("slider--item-center1").next().addClass("slider--item-center1"), u.removeClass("slider--item-right1").first().addClass("slider--item-right1")) : 0 !== i && 0 !== s && 0 !== o ? (l.removeClass("slider--item-left1").prev().addClass("slider--item-left1"), c.removeClass("slider--item-center1").prev().addClass("slider--item-center1"), h.removeClass("slider--item-right1").prev().addClass("slider--item-right1")) : 0 === i ? (u.removeClass("slider--item-left1").last().addClass("slider--item-left1"), c.removeClass("slider--item-center1").prev().addClass("slider--item-center1"), h.removeClass("slider--item-right1").prev().addClass("slider--item-right1")) : 0 === s ? (l.removeClass("slider--item-left1").prev().addClass("slider--item-left1"), u.removeClass("slider--item-center1").last().addClass("slider--item-center1"), h.removeClass("slider--item-right1").prev().addClass("slider--item-right1")) : (l.removeClass("slider--item-left1").prev().addClass("slider--item-left1"), c.removeClass("slider--item-center1").prev().addClass("slider--item-center1"), u.removeClass("slider--item-right1").last().addClass("slider--item-right1"))
            },
            400),
            $(".slider1").animate({
                opacity: 1
